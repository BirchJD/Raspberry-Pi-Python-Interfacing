...
def InitSPI():
   ...
   WriteGPIO("/dev/RPiSPi_0011_001_5_4_MCP23S17_IPOL", 0xF00F)
   ...
   SPiDisplayFile = open("/dev/RPiSPi_0010_000_2_1_SSD1306_WRITE", 'wb', 0)
...
def GetGpioKeys():
   return ReadGPIO("/dev/RPiSPi_0011_001_5_2_MCP23S17_READ")
