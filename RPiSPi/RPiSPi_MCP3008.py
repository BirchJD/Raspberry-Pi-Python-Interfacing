...
#/****************************************************/
   ...
   Value0 = ReadAD("/dev/RPiSPi_000_000_0_2_MCP3008_READ0")
   Value1 = ReadAD("/dev/RPiSPi_000_000_0_3_MCP3008_READ1")
   Value2 = ReadAD("/dev/RPiSPi_000_000_0_4_MCP3008_READ2")
   Value3 = ReadAD("/dev/RPiSPi_000_000_0_5_MCP3008_READ3")
   Value4 = ReadAD("/dev/RPiSPi_000_000_0_6_MCP3008_READ4")
   Value5 = ReadAD("/dev/RPiSPi_000_000_0_7_MCP3008_READ5")
   Value6 = ReadAD("/dev/RPiSPi_000_000_0_8_MCP3008_READ6")
   Value7 = ReadAD("/dev/RPiSPi_000_000_0_9_MCP3008_READ7")
