...
def InitSPI():
   ...
   WriteGPIO("/dev/RPiSPi_00011_001_4_0_MCP23S17_INIT", SPI_DEV_CMD_MCP23S17_INIT)
   WriteGPIO("/dev/RPiSPi_00011_001_4_3_MCP23S17_IODIR", 0xFFFF)
   WriteGPIO("/dev/RPiSPi_00011_001_4_4_MCP23S17_IPOL", 0xF00F)
   WriteGPIO("/dev/RPiSPi_00011_001_4_5_MCP23S17_GPINTEN", 0x0000)
   WriteGPIO("/dev/RPiSPi_00011_001_4_6_MCP23S17_DEFVAL", 0x0000)
   WriteGPIO("/dev/RPiSPi_00011_001_4_7_MCP23S17_INTCON", 0x0000)
   WriteGPIO("/dev/RPiSPi_00011_001_4_8_MCP23S17_GPPU", 0xF00F)
   
   WriteGPIO("/dev/RPiSPi_10011_000_8_0_SSD1306_INIT", SPI_DEV_CMD_SSD1306_INIT)
   SPiDisplayFile = open("/dev/RPiSPi_10011_000_8_1_SSD1306_WRITE", 'wb', 0)
...
def GetGpioKeys():
   return ReadGPIO("/dev/RPiSPi_00011_001_4_2_MCP23S17_READ")
